...
type Users interface {
	...
	GetUserRolesByID(ctx context.Context, id int) ([]string, error)
	...
	AddRole(ctx context.Context, login string, role string) error
	RemoveRole(ctx context.Context, login string, role string) error
}
